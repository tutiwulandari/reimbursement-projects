...
export default function OfficeTravelClaims() {
    return(
        <div>
            <div className="col-md-6 offset-md-3 mt-5">
                ...
                <form>
                    ...
                    <div className="form-group">
                        <label htmlFor="start_travel" required="required">Date Start Travel</label>
                        <input type="date" name="start_travel" className="form-control" id="start_travel"/>
                    </div>

                    <div className="form-group">
                        <label htmlFor="end_travel" required="required">Date End Travel</label>
                        <input type="date" name="end_travel" className="form-control" id="end_travel"/>
                    </div>
