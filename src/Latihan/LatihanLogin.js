...
export default function LatihanLogin() {
    return(
                ...
                <div className="row d-flex">
                    <div className="col-lg-6">
                        <div className="card1 pb-5">
                            ...
                            <div>
                                {/*<img src={Image} class="image" style={{marginTop:"100px"}}/>*/}
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-6" style={{marginLeft: "300px"}}>
                        <div className="card2 card border-0 px-4 py-25">
                ...
                <div className="bg-blue py-4">
                    <div className="row px-3"><small className="ml-4 ml-sm-5 mb-2">Copyright &copy; 2019. All rights
                        ...
                        <div className="social-contact ml-4 ml-sm-auto">
                            ...
                            </span> <span className="fa fa-google-plus mr-4 text-sm"></span>
                            <span className="fa fa-linkedin mr-4 text-sm">

                            </span> <span className="fa fa-twitter mr-4 mr-sm-5 text-sm"></span>
                        </div>
                    </div>
                </div>
            </div>
