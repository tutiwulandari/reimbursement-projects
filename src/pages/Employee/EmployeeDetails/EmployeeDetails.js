...
//
//
// function EmployeeDetails( {isLoading, employee, findById}) {
//
...
//                         { isLoading ?  employee.data &&
//                            <tr>
//                                  <td>{employee.data.fullname}</td>
//                                  <td>{employee.data.placeOfBirth}</td>
//                                  <td>{employee.data.dateOfBirth}</td>
//                                  <td>{employee.data.gender}</td>
//                                  <td>{employee.data.religion}</td>
//                                  <td>{employee.data.bloodType}</td>
