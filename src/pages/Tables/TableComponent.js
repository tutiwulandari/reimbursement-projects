...
import {faCheck, faEdit, faUserPlus} from "@fortawesome/free-solid-svg-icons";
...
function TableComponent({findAll, employees, error, isLoading}) {
    ...
    return(
        <div className="container" style={{marginBottom:"50px"}}>
            <DashboardHc/>
            <h1 style={{textAlign:"center", marginTop:"50px"}}> List Karyawan </h1>
                        ...
                        employees?.data?.data.map((element, index) => {
                            return (
                                <tr style={{textAlign: "center"}}>
                                    ...
                                    <td style={{verticalAlign:"middle", textAlign:"center", maxWidth:"200px", minWidth:"200px"}}><Button> <FontAwesomeIcon icon={faCheck}/></Button></td>
